// Copyright 2013 Sunjay Dhama with permission from Clark Duvall
//
...
_HandleSpecialKey: function(key, e) {
                      ...
                      // TODO: move blinker to the left.
                         ...
                         // blinker.insertBefore(stdout.innerHTML);
                      }
                      // Up arrow.
                      else if (key == 38) {
...
_Execute: function(fullCommand) {
   ...
   term.Init(CONFIG, '/json/mobile_filesystem.json', COMMANDS, function() {
         term.Enqueue('login');
         term.Enqueue('sunjay');
         term.Enqueue('********');
