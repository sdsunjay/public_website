...
*/
  ...
  term.init(CONFIG, 'https://raw.githubusercontent.com/sdsunjay/public_website/master/projects/terminal/json/filesystem.json', COMMANDS, function() {
    term.enqueue('login')
      .enqueue('sunjay')
      .enqueue('******')
      .enqueue('cat README')
