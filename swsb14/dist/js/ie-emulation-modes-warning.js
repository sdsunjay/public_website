...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?v=3&amp;s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="68836527:67D0:1274912E:5467C1F9" name="octolytics-dimension-request_id" />
...
<meta content="wjmlKWY027OScaEwUJe38zutK7KrGVHzyxncMjMQRlPylNmaJdJCOlm1nQwo7DQQC6hI7tfsiit4YkEf4cj9qw==" name="csrf-token" />
...
<a href="/twbs/bootstrap/blob/0c1527010893065635b8af7df221db9edb3e8971/docs/assets/js/ie-emulation-modes-warning.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>
...
<div class="select-menu js-menu-container js-select-menu left">
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/docs-access/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/docs-gh/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="docs-gh"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/dropdowns-events/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/events-tables-wrapping/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/examples-img-alt/docs/assets/js/ie-emulation-modes-warning.js"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/grunt-combine-media-queries/docs/assets/js/ie-emulation-modes-warning.js"
  ...
  <div class="button-group right">
    ...
    <button aria-label="Copy to clipboard" class="js-zeroclipboard minibutton zeroclipboard-button" data-clipboard-text="docs/assets/js/ie-emulation-modes-warning.js" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
  </div>
...
<div class="file-box">
  ...
  <div class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC10" class="blob-code js-file-line"><span class="pl-c"><span class="pl-pdc">//</span> Intended to prevent false-positive bug reports about Bootstrap not working properly in old versions of IE due to folks testing using IE&#39;s unreliable emulation modes.</span></td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code js-file-line">(<span class="pl-s">function</span> () {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code js-file-line">  <span class="pl-s">function</span> <span class="pl-enf">emulatedIEMajorVersion</span>() {</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code js-file-line">    <span class="pl-s">var</span> groups <span class="pl-ko">=</span><span class="pl-sr"> <span class="pl-pds">/</span>MSIE (<span class="pl-c1">[<span class="pl-c1">0-9</span><span class="pl-c1">.</span>]</span><span class="pl-ko">+</span>)<span class="pl-pds">/</span></span>.<span class="pl-sf">exec</span>(<span class="pl-sc">window</span>.<span class="pl-sc">navigator</span>.userAgent)</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code js-file-line">    <span class="pl-k">if</span> (groups <span class="pl-ko">===</span> <span class="pl-c1">null</span>) {</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code js-file-line">    <span class="pl-s">var</span> ieVersionNum <span class="pl-ko">=</span> <span class="pl-sf">parseInt</span>(groups[<span class="pl-cn">1</span>], <span class="pl-cn">10</span>)</td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code js-file-line">    <span class="pl-s">var</span> ieMajorVersion <span class="pl-ko">=</span> <span class="pl-sc">Math</span>.<span class="pl-sf">floor</span>(ieVersionNum)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code js-file-line">  <span class="pl-s">function</span> <span class="pl-enf">actualNonEmulatedIEMajorVersion</span>() {</td>
      </tr>
      <tr>
        <td id="L25" class="blob-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-code js-file-line">    <span class="pl-c"><span class="pl-pdc">//</span> Detects the actual version of IE in use, even if it&#39;s in an older-IE emulation mode.</span></td>
      </tr>
      <tr>
        <td id="L26" class="blob-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-code js-file-line">    <span class="pl-c"><span class="pl-pdc">//</span> IE JavaScript conditional compilation docs: http://msdn.microsoft.com/en-us/library/ie/121hztk3(v=vs.94).aspx</span></td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code js-file-line">    <span class="pl-c"><span class="pl-pdc">//</span> @cc_on docs: http://msdn.microsoft.com/en-us/library/ie/8ka90k2e(v=vs.94).aspx</span></td>
      </tr>
      <tr>
        <td id="L28" class="blob-num js-line-number" data-line-number="28"></td>
        <td id="LC28" class="blob-code js-file-line">    <span class="pl-s">var</span> jscriptVersion <span class="pl-ko">=</span> <span class="pl-ko">new</span> <span class="pl-enti">Function</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>/*@cc_on return @_jscript_version; @*/<span class="pl-pds">&#39;</span></span>)() <span class="pl-c"><span class="pl-pdc">//</span> jshint ignore:line</span></td>
      </tr>
      <tr>
        <td id="L29" class="blob-num js-line-number" data-line-number="29"></td>
        <td id="LC29" class="blob-code js-file-line">    <span class="pl-k">if</span> (jscriptVersion <span class="pl-ko">===</span> <span class="pl-c1">undefined</span>) {</td>
      </tr>
      <tr>
        <td id="L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-code js-file-line">      <span class="pl-k">return</span> <span class="pl-cn">11</span> <span class="pl-c"><span class="pl-pdc">//</span> IE11+ not in emulation mode</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC32" class="blob-code js-file-line">    <span class="pl-k">if</span> (jscriptVersion <span class="pl-ko">&lt;</span> <span class="pl-cn">9</span>) {</td>
      </tr>
      <tr>
        <td id="L33" class="blob-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-code js-file-line">      <span class="pl-k">return</span> <span class="pl-cn">8</span> <span class="pl-c"><span class="pl-pdc">//</span> IE8 (or lower; haven&#39;t tested on IE&lt;8)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC35" class="blob-code js-file-line">    <span class="pl-k">return</span> jscriptVersion <span class="pl-c"><span class="pl-pdc">//</span> IE9 or IE10 in any mode, or IE11 in non-IE11 mode</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC38" class="blob-code js-file-line">  <span class="pl-s">var</span> ua <span class="pl-ko">=</span> <span class="pl-sc">window</span>.<span class="pl-sc">navigator</span>.userAgent</td>
      </tr>
      <tr>
        <td id="L39" class="blob-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-code js-file-line">  <span class="pl-k">if</span> (ua.<span class="pl-sf">indexOf</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>Opera<span class="pl-pds">&#39;</span></span>) <span class="pl-ko">&gt;</span> <span class="pl-ko">-</span><span class="pl-cn">1</span> <span class="pl-ko">||</span> ua.<span class="pl-sf">indexOf</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>Presto<span class="pl-pds">&#39;</span></span>) <span class="pl-ko">&gt;</span> <span class="pl-ko">-</span><span class="pl-cn">1</span>) {</td>
      </tr>
      <tr>
        <td id="L40" class="blob-num js-line-number" data-line-number="40"></td>
        <td id="LC40" class="blob-code js-file-line">    <span class="pl-k">return</span> <span class="pl-c"><span class="pl-pdc">//</span> Opera, which might pretend to be IE</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC42" class="blob-code js-file-line">  <span class="pl-s">var</span> emulated <span class="pl-ko">=</span> emulatedIEMajorVersion()</td>
      </tr>
      <tr>
        <td id="L43" class="blob-num js-line-number" data-line-number="43"></td>
        <td id="LC43" class="blob-code js-file-line">  <span class="pl-k">if</span> (emulated <span class="pl-ko">===</span> <span class="pl-c1">null</span>) {</td>
      </tr>
      <tr>
        <td id="L44" class="blob-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-code js-file-line">    <span class="pl-k">return</span> <span class="pl-c"><span class="pl-pdc">//</span> Not IE</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC46" class="blob-code js-file-line">  <span class="pl-s">var</span> nonEmulated <span class="pl-ko">=</span> actualNonEmulatedIEMajorVersion()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC48" class="blob-code js-file-line">  <span class="pl-k">if</span> (emulated <span class="pl-ko">!==</span> nonEmulated) {</td>
      </tr>
      <tr>
        <td id="L49" class="blob-num js-line-number" data-line-number="49"></td>
        <td id="LC49" class="blob-code js-file-line">    <span class="pl-sc">window</span>.<span class="pl-sf">alert</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>WARNING: You appear to be using IE<span class="pl-pds">&#39;</span></span> <span class="pl-ko">+</span> nonEmulated <span class="pl-ko">+</span> <span class="pl-s1"><span class="pl-pds">&#39;</span> in IE<span class="pl-pds">&#39;</span></span> <span class="pl-ko">+</span> emulated <span class="pl-ko">+</span> <span class="pl-s1"><span class="pl-pds">&#39;</span> emulation mode.<span class="pl-cce">\n</span>IE emulation modes can behave significantly differently from ACTUAL older versions of IE.<span class="pl-cce">\n</span>PLEASE DON<span class="pl-cce">\&#39;</span>T FILE BOOTSTRAP BUGS based on testing in IE emulation modes!<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02590s from github-fe128-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
